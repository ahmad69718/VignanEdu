...
export default function NotificationDropdownComponent()
{
    ...
    return(<div className={`fixed h-96 w-1/4 ${notification === 1 ? 'block' : 'hidden'} z-10 ${lightdarkmodevalue === 1 ? 'bg-stone-900' : 'bg-white'} right-4 top-14 border border-blue-500 rounded-md ${lightdarkmodevalue=== 1 ? 'text-gray-400' : 'text-black'} p-3`}>
